// ==========================================================================
// Assur Chap Mobile — Moteur de tarification & comparateur (partagé avec le web)
// ==========================================================================
...
export const COVERAGES: Record<CoverageId, Coverage> = {
  ...
  tous_risques: {
    ...
    name: "Tous Risques",
    short: "Tous risques",
    guarantees: ["Responsabilité civile", "Dommages tous accidents", "Vol & incendie", "Bris de glace", "Catastrophes naturelles", "Assistance 0 km", "Véhicule de remplacement"],
  },
};

export const INSURERS: Insurer[] = [
  { id: "nsia", name: "NSIA Assurances", rating: 4.6, mult: 1.0, accent: "#1F7A8C", claimDays: 7, desc: "Leader de la bancassurance." },
  { id: "sunu", name: "SUNU Assurances", rating: 4.4, mult: 0.92, accent: "#2d72b8", claimDays: 9, desc: "Bon rapport qualité-prix." },
  { id: "saham", name: "Saham Assurance", rating: 4.5, mult: 1.08, accent: "#7c4dff", claimDays: 6, desc: "Service premium." },
  { id: "axa", name: "AXA Afrique", rating: 4.7, mult: 1.2, accent: "#00008f", claimDays: 5, desc: "Garanties les plus complètes." },
  { id: "allianz", name: "Allianz Africa", rating: 4.3, mult: 0.97, accent: "#003781", claimDays: 8, desc: "Assistance étendue." },
  { id: "sanlam", name: "Sanlam Assurances", rating: 4.2, mult: 0.88, accent: "#1f9d6b", claimDays: 10, desc: "Tarifs accessibles." },
];
...
export function annualBase(vehicle: Partial<Vehicle>, coverageId: CoverageId): number {
  const power = Number(vehicle.power) || 7;
  const value = Number(vehicle.value) || 5000000;
...
export function sortOffers(offers: Offer[], mode: SortMode): Offer[] {
  ...
  else a.sort((x, y) => x.price - y.price);
  return a;
}
